...
TEST(TestIndicators, compute_simple_moving_average)
{
...
TEST(TestIndicators, compute_simple_moving_average_balance)
{
  std::vector<float> prices = {1.0, 3.0, 4.0, 2.0, 1.0, 3.0};
  const unsigned numSMAPeriods = 4;
  std::vector<float> expectedSma4
...
TEST(TestIndicators, compute_1st_derivative_dx2)
{
...
TEST(TestIndicators, compute_1st_derivative_dx3)
{
...
TEST(TestIndicators, compute_2nd_derivative_dx3)
{
...
TEST(TestIndicators, compute_2nd_derivative_dx4)
{
  std::vector<float> vals = {1.0, 3.0, 2.0, 2.0, 3.0, 4.0, 3.0};
  unsigned widthDx = 4;
